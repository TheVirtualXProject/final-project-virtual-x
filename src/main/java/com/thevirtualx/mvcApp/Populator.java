...
public class Populator {
    ...
    public Populator(AccountStorage accountStorage, ChallengeStorage challengeStorage,
                     ChatroomStorage chatroomStorage, CommentStorage commentStorage, GameStorage gameStorage) {
    ...
    public void run(String... args) throws Exception{
        Account lani = new Account("TurboJay", "GoWeiwei", "Jelanie Starks", 0,
                "https://static.wikia.nocookie.net/dragonball/images/5/58/GokuSuperSaiyanTransformedAtLast.png/revision/latest/scale-to-width-down/200?cb=20191103030051");
        accountStorage.addAccount(lani);

        Account connor = new Account("Ronnoc", "GoWeiwei", "Connor Chambers", 0,
                "https://4.bp.blogspot.com/-puG6A6cjmI8/VeDXT2if2bI/AAAAAAAAgnE/EIC6fuiO2NY/s1600/Blue%2BJay%252C%2B8-12-2015-3896-3.jpg");
